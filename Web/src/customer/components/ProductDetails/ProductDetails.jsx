...
export default function ProductDetails() {
    ...
    return (
        <div className="bg-white">
                ...
                <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-20">
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <form className="mt-10">
                            ...
                            <Button color="secondary" variant="contained" sx={{px:"2rem",py:"1rem",bgcolor:"#fff0f3", color: "#000"}} >
            ...
            {/* rating and reviews */}
            <section>
              <h1 className='front-semibold text-lg pb-4'>Recent Review and Rating </h1>
