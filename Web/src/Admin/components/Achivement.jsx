...
const Achivement = () => {
  return (
<Card sx={{bgcolor:"#FFC0CB",position:"relative"}}>
    <CardContent>
        ...
        <Button size='small' variant='container'   sx={{ bgcolor: '#ba34eb', color: 'white' }}> View Sales</Button> 
        <Typography src='img'></Typography>
